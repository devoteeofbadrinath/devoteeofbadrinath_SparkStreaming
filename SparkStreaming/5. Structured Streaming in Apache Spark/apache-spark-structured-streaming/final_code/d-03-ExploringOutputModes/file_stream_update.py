...
def main():
    spark = SparkSession.builder \
        .appName("FileStreamUpdateModeDemo") \
        .getOrCreate()
    ...
    count_df = filtered_df.groupBy("Manufacturer").count()

    # Write the stateful count to the console in Update mode (only changed rows are output)
