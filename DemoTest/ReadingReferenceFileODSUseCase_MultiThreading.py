...
def transform_data(
    ...
    transformed_df = transformed_df.selectExpr("ACNT_ID_NUM","LDGR_BAL_AMT_NEW as LDGR_BAL_AMT","LDGR_BAL_SEQ_NEW as LDGR_BAL_SEQ","LDGR_BAL_DTTM_NEW as LDGR_BAL_DTTM","SHDW_BAL_AMT_NEW as SHDW_BAL_AMT","SHDW_BAL_SEQ_NEW as SHDW_BAL_SEQ","SHDW_BAL_DTTM_NEW as SHDW_BAL_DTTM")
